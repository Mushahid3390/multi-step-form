    ...
    <div className={styles.sidebar}>
      <div className={styles.sidebar__panel}>
        ...
        <div className={styles.sidebar__stepsCont}>
          <div className={`${styles.sidebar__section}`}>
            <p
              className={`${styles.sidebar__step} ${stepN >= 1 ? styles['sidebar__step--active'] : ''}`}
            >
              1
            </p>
            <div>
          ...
          <div className={`${styles.sidebar__progress}`}>
            <div
              className={`${styles.sidebar__progLine} ${stepN > 1 ? styles['sidebar__progLine--completed'] : ''}`}
            ></div>
          </div>

          <div className={`${styles.sidebar__section}`}>
            <p
              className={`${styles.sidebar__step} ${stepN >= 2 ? styles['sidebar__step--active'] : ''}`}
            >
              2
            </p>
            <div>
          ...
          <div className={`${styles.sidebar__progress}`}>
            <div
              className={`${styles.sidebar__progLine} ${stepN > 2 ? styles['sidebar__progLine--completed'] : ''}`}
            ></div>
          </div>

          <div className={`${styles.sidebar__section}`}>
            <p
              className={`${styles.sidebar__step} ${stepN >= 3 ? styles['sidebar__step--active'] : ''}`}
            >
              3
            </p>
            <div>
      ...
      <div className={styles.sidebar__footer}>
        ...
        <Image
          src={headPhoneLogo}
          alt="logo"
          className={styles.sidebar__footIcon}
        />
      </div>
    </div>
  );
