    ...
    <div className={`${styles.personalInfoSec}`}>
      <div className={`${styles.personalInfoSec__Cont}`}>
        <form
          ...
          className={`${styles.personalInfoSec__Form}`}
        >
          <h3 className={`${styles.personalInfoSec__Title}`}>
          ...
          <div className={`${styles.personalInfoSec__Inputs}`}>
            <div>
              ...
              {Object.keys(error).length > 0 && (
                <p className={styles.personalInfoSec__errors}>{error.name}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {Object.keys(error).length > 0 && (
                <p className={styles.personalInfoSec__errors}>{error.email}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {Object.keys(error).length > 0 && (
                <p className={styles.personalInfoSec__errors}>{error.phone}</p>
              )}
            </div>
